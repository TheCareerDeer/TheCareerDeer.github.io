...
function updateNavBar() {
	...
	try {
		...
		accountButtons.innerHTML = `<div id="dropdown" class="dropdown"><div id="hider" class="dropdown-content">
			...
			<a href="https://thecareerdeer.com/companies/">COMPANIES&nbsp;&nbsp&nbsp<img src="https://cdn1.iconfinder.com/data/icons/camping-adventure-and-outdoors-1/32/cottage-cabin-wood-house-camping-outdoor-stay-512.png" style="height: 22px; position: absolute; margin-left: 1px; margin-top: -5px;" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
