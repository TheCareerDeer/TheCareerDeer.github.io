...
function updateNavBar() {
	try {
		...
		accountButtons.innerHTML = `<div class="dropdown"><div class="dropdown-content">
			<br><br><br>
			<a href="saved/">My Jobs&nbsp;&nbsp;<img src="https://thecareerdeer.com/src/images/save-checked.png" style="height: 24px; position: absolute; margin-left: -3px; margin-top: -2px;" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
			<a href="saved/">Organizations&nbsp;&nbsp;<img src="https://thecareerdeer.com/src/images/organization.png" style="height: 24px; position: absolute; margin-left: -3px; margin-top: -2px;" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
			<a href="https://thecareerdeer.com/about/">About Us&nbsp;&nbsp;<img src="https://thecareerdeer.com/src/images/logo/small.png" style="height: 21px; position: absolute; margin-left: 1px; margin-top: -2px;" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
			<a style="border-bottom-left-radius: 5px" id="logout" href=".">Log Out&nbsp;&nbsp;<img src="https://thecareerdeer.com/src/images/logout.png" style="height: 14px; width: 18px; position: absolute; margin-top: 2px; margin-left: 3px; opacity: .9;" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
		  </div></div>`;
